	...
	<section class="signup">
		...
		<spring:bind path="username">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				<span><img src="../../resources/img/ggg.png" alt="person"></span>
			...
			<spring:bind path="password">
				<div class="form-group ${status.error ? 'has-error' : ''}">
					<span><img src="../../resources/img/ggg.png" alt="person2"></span>
		...
		<%--<div class="input_field">--%>
				<%--<span><img src="../../resources/img/ggg.png" alt="person"></span><input type="First name" placeholder="First name" required="">--%>
				<%--<span><img src="../../resources/img/ggg.png" alt="person2"></span><input type="Last name" placeholder="Last name" required="">--%>
